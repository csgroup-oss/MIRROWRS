...
def test_sig_inverse_project_1():
    ...
    lon_tst, lat_tst = project(x, y, lon_0=lon_gold[0], lat_0=lat_gold[0], x_0=0., y_0=0., inverse=True)
...
def test_sig_project_2():
    ...
    proj = pyproj.Proj( proj="laea", lat_0=lat_0, lon_0=lon_0, x_0=x_0, y_0=y_0, ellps="WGS84")
